        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-xl text-slate-300 max-w-2xl font-medium leading-relaxed">
              Discover verified legal professionals near you using Google Maps integration.
            </p>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden transition-all duration-300 hover:shadow-2xl">
              <div className="p-5 border-b border-slate-100 bg-slate-50/50">
                <h3 className="text-lg font-bold text-slate-800 flex items-center uppercase tracking-wider">
                  <span className="mr-3 text-blue-600">🗺️</span> Google Maps Integration
                </h3>
              </div>
              <div className="p-4">
                <LegalMap />
            ...
            <div className="bg-slate-900 rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <h4 className="text-lg font-bold mb-4 flex items-center tracking-wider">
                  <span className="mr-3 text-blue-400">🛡️</span> POWERED BY GOOGLE
                </h4>
                <p className="text-sm text-slate-300 leading-7 font-medium">
                  Real-time lawyer locations powered by Google Places API. All data is sourced directly from Google's verified business directory.
                </p>
                <div className="mt-6 pt-6 border-t border-slate-800 flex items-center justify-between">
                  <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Google Maps API</span>
                  <span className="text-blue-400 text-xs font-black cursor-pointer hover:underline uppercase tracking-widest">Learn More →</span>
                </div>
              </div>
            </div>
          </div>
